...
//********* PARAMETROS DE LISTA DE DATOS **********************
function init_echarts(data_nombre, data_tiempo, data_valor){
...
if("undefined"!=typeof echarts){
    ...
    var a={color:["#26B99A","#34495E","#BDC3C7","#3498DB","#9B59B6","#8abb6f","#759c6a","#bfd3b7"],
        ...
        tooltip:{backgroundColor:"rgba(0,0,0,0.5)",
            axisPointer:{type:"line",lineStyle:{color:"#408829",type:"dashed"},
        ...
        grid:{borderWidth:0},categoryAxis:{axisLine:{lineStyle:{color:"#408829"}},
        ...
        timeline:{lineStyle:{color:"#408829"},
            controlStyle:{normal:{color:"#408829"},
...
if($("#echart_line").length){
    ...
    var cont = 0;
    for(var i=data_valor.length-1; i>=0; i--) {
        arr_series[cont] = {
                name:data_nombre[i],
                type:"line",
                smooth:!1,
    ...
    f.setOption({
        ...
        //legend:{x:0,y:0,data:["Intent","Pre-order","Deal","Deal_2","Deal_3","Deal_4"]},
        legend:{x:0,y:0,data:data_nombre},
        toolbox:{
            show:!0,feature:{
                /*restore:{
                    show:!0,
        ...
        series:arr_series
                ...
                smooth:!1,
                itemStyle:{normal:{areaStyle:{type:"default"}}},
                data:[18,56,25,5,26,35,600]},
                {
                name:"Deal_3",
                type:"line",
                smooth:!1,
                itemStyle:{normal:{areaStyle:{type:"default"}}},
                data:[51,81,2,55,62,38,700]},
                {
                name:"Deal_2",
                type:"line",
                smooth:!1,
                itemStyle:{normal:{areaStyle:{type:"default"}}},
                data:[15,18,20,5,26,83,71]},
                {
                name:"Deal",
                type:"line",
                smooth:!1,
